...
public class GradeBookControllerTest {
    ...
    public void createGradeService() {
        ...
        // Create the grade
        assertTrue(studentCreateServiceMock.createGrade(80.50, 1, "math"));
        assertTrue(studentCreateServiceMock.createGrade(80.50, 1, "science"));
        assertTrue(studentCreateServiceMock.createGrade(80.50, 1, "history"));
