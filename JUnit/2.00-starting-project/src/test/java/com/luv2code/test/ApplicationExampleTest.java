...
public class ApplicationExampleTest {
    ...
    public void checkNullForStudentGrades() {
        assertNotNull(student.getStudentGrades().checkNull(student.getStudentGrades().getMathGradeResults()),
    ...
    public void createStudentWithoutGradeInit() {
        ...
        studentTwo.setLastname("Roby");
        studentTwo.setEmailAddress("chad.roby@luv2code_school.com");
    ...
    @Test
    public void findGradePointAverag() {
        assertAll("Testing assertEquals ",
                () ->
                        assertEquals(353.25, studentGrades.addGradeResultsForSingleClass(
                                student.getStudentGrades().getMathGradeResults())),
